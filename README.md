...
Course Title: Bachelor of Science (Regular) Information Technology
Index Number: [Insert Index Number]
Level: [Insert Level]
Lecturer's name: [Insert Lecturer's Name]

Please note that you will need to fill in the specific course code, index number, level, and lecturer's name. If you need more information about the program, you can visit the Department of Computer Science and Information Technology's website or contact them at dcsit@ucc.edu.gh or 054978213.
